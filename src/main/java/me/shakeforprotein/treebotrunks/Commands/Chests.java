...
public class Chests implements CommandExecutor {
    ...
    public Chests(TreeboTrunk main) {
        this.pl = main;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            ItemStack standardChest = new ItemStack(Material.CHEST, 1);
            int i = 0;
            ...
            for (i = 0; i < max; i++) {
                ...
                if (invYaml.get("icon") != null) {
                    ItemStack icon = new ItemStack(Material.valueOf(invYaml.getString("icon").toUpperCase()), 1);
